...
class _DetailState extends State<Detail> {
  ...
  void bookFindCommentsById(int bid) async {
    try {
      final response = await dio.get("http://192.168.40.40:8080/task/review?bid=$bid");
      setState(() {
  ...
  void postReview(int bid) async {
    ...
    try {
      final response = await dio.post(
        "http://192.168.40.40:8080/task/review",
        data: {
          "bid": bid,
          "rcontent": content,
          "rpwd": password,
  ...
  void deleteComment(int rid, int bid) async {
    ...
    try {
      final response = await dio.delete(
        "http://192.168.40.40:8080/task/review?rid=$rid",
